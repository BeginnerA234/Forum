...
class ProfileAPITestCase(APITestCase, SetUp):
    ...
    def test_get_detail(self):
        ...
        ).select_related('country').prefetch_related('follow', 'user_comment', 'user').order_by('id').first()
...
class IgnoreUserTestCase(APITestCase):
    ...
    def setUp(self):
        self.user_1 = User.objects.create_user(username='BeginnerA234', first_name='Kirill', last_name='Lobashov',
                                               email='proverka@gmail.com', password='proverka3004', is_active=True)
        self.user_2 = User.objects.create_user(username='User2', first_name='Andrey', last_name='Palchikov',
                                               email='palchikov_andrey@yandex.ru', password='proverka1234',
                                               is_active=True)
        self.user_3 = User.objects.create_user(username='User3', first_name='Vladimir', last_name='Putin',
